...
exports.fundHoldingsRouter = void 0;
const express_1 = require("express");
const cache_1 = require("../middleware/cache");
const html_1 = require("../parsers/html");
const router = (0, express_1.Router)();
exports.fundHoldingsRouter = router;
...
router.get('/:code', async (req, res, next) => {
    try {
        ...
        const data = await (0, cache_1.getCachedOrFetch)(cache_1.holdingsCache, `holdings-${code}`, async () => {
            ...
            return (0, html_1.parseHoldings)(html);
        });
        res.json(data);
    }
    catch (err) {
...
//# sourceMappingURL=fund-holdings.js.map